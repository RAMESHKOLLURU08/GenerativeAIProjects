'''
Project: 
Source: https://learn.microsoft.com/en-us/training/modules/build-language-understanding-model/1-introduction
...
Goto Language Studio and create a project for Conversational language understanding
Label each intent with sample utterancesCreate intents
Train and test the model
Add entities
Add a list entity
Add a prebuilt entity
Retrain the model
Use the model from a client app in visual studio code.
You have to update environment file with key and endpoint.
LS_CONVERSATIONS_ENDPOINT='https://rklanginstance.cognitiveservices.azure.com/' (this is for sample)
LS_CONVERSATIONS_KEY='166e1a1a9d7a4fb4b5aa587903aa1980'
'''
